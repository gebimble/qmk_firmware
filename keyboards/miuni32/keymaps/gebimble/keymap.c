...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------------------------------|
     * |LT(3|Z)|   X   |   C   |   V   |      SPC      |   B   |   N   |   M   |   ,   |LT(2|.)|
     * |---------------------------------------------------------------------------------------|
     */
  [0] = LAYOUT(
    KC_Q,        KC_W, KC_E, KC_R, KC_T, KC_Y,   KC_U, KC_I, KC_O, KC_P,    KC_BSPC,
    KC_A,        KC_S, KC_D, KC_F, KC_G, KC_H,   KC_J, KC_K, KC_L, KC_ENT,  LT(1, KC_SCLN),
    LT(3, KC_Z), KC_X, KC_C, KC_V, SFT_T(KC_SPC),KC_B, KC_N, KC_M, KC_COMM, LT(2, KC_DOT)
  ),
  ...
  [2] = LAYOUT(
    ...
    KC_LSFT, KC_LCTL, KC_L,    KC_T,    SFT_T(KC_SPC)   ,  KC_N,    _______, _______, KC_RCTL, _______
  ),
  /* Level 3: RGB Layer
     * ,---------------------------------------------------------------------------------------.
